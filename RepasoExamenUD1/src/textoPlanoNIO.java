...
public class textoPlanoNIO {
    public static void main(String[] args) {
        ...
        try{
            Files.writeString(rutaFichero,texto,StandardOpenOption.CREATE,StandardOpenOption.TRUNCATE_EXISTING);
            texto = "Esto es una segunda cadena de prueba\n";
            Files.writeString(rutaFichero, texto,StandardOpenOption.APPEND);
